...
HOME=/home/k00914150
MODEL_PATH=/home/k00914150/Temp/Spec-RL/model/Qwen3-1.7B-base
SAVE_PATH=/home/k00914150/new_verl/verl 
PROJECT_NAME=test_baseline_first_run 
EXPERIMENT_NAME=spec_rl_first_run_0.5
TOTAL_EPOCHS=2 
NGPUS_PER_NODE=2
ROLLOUT_TP=1
DEVICE=gpu
...
TRAINER=(
    ...
    trainer.rollout_data_dir=/data/k00914150/specrl_0_5/rollouts/${EXPERIMENT_NAME} \
